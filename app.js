(() => {
  ...
  function bindLesson(l,w){
    ...
    if(testAnother) testAnother.addEventListener('click',()=>{
      setWork(id,{response:'',formativePassed:false,selectedAnswer:null,understandingPassed:false});
      renderLesson();
